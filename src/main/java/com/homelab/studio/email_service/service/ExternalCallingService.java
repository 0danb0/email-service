package com.homelab.studio.email_service.service;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.homelab.studio.email_service.config.OkHttpClientCustom;
import com.homelab.studio.email_service.model.components.UserGuiDTO;
...
public class ExternalCallingService {
    private static final String USER_SERVICE_URL = "https://tu-zia-pelata.it/col-cerchietto/";
